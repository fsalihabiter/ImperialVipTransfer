...
namespace ImperialVip.WebUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Logo()
        {
            ...
            {
                Icerik logo = unitOfWork.Icerikler.Find(l => l.IcerikKategoriId == 8 && l.DilId == 2);
        ...
        public ActionResult Footer()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                Icerik footer = unitOfWork.Icerikler.Find(l => l.IcerikKategoriId == 7 && l.DilId == 2);
                ViewBag.iletisim = unitOfWork.Icerikler.FindAll(i => i.IcerikKategoriId == 5 && i.DilId == 2).ToList();
        ...
        public ActionResult Slider()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                ...
                ViewBag.slider = unitOfWork.Icerikler.Find(s => s.IcerikKategoriId == 1 && s.DilId == 2);
        ...
        public ActionResult OurServices()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> hizmetler = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 2 && s.DilId == 2).ToList();
        ...
        public ActionResult AboutUs()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> hakkimizda = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 3 && s.DilId == 2).ToList();
                ViewBag.kategori = unitOfWork.Kategoriler.Get(3);
        ...
        public ActionResult WhyUs()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> nedenBiz = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 4 && s.DilId == 2).ToList();
                ViewBag.kategori = unitOfWork.Kategoriler.Get(4);
        ...
        public JsonResult ContactUs(BizeUlasinDTO bizeUlasinModel)
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                ...
                return Json(new { success = false, message = "Your message could not be delivered due to a problem." }, JsonRequestBehavior.AllowGet);
        ...
        public JsonResult Comments(YorumViewModel yorumModel)
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                ...
                return Json(new { success = true, message = "Your comment has been sent successfully." }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public ActionResult Contact()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> iletisim = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 5 && s.DilId == 2).ToList();
        ...
        public ActionResult Faq()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> sss = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 6 && s.DilId == 2).ToList();
        ...
        public JsonResult Reservation(RezervasyonBilgileri rezervasyonBilgileri)
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                ...
                {
                    return Json(new { success = true, message = "Your reservation request has been received." }, JsonRequestBehavior.AllowGet);
                }
            }

            return Json(new { success = false, message = "Your reservation request could not be received due to a problem." }, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        [Route("en/VarisNoktasiBelirle")]
