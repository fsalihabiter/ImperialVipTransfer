...
namespace ImperialVip.WebUI.Controllers
{
    ...
    public class HomeRuController : Controller
    {
        ...
        public ActionResult Logo()
        {
            ...
            {
                Icerik logo = unitOfWork.Icerikler.Find(l => l.IcerikKategoriId == 8 && l.DilId == 4);
        ...
        public ActionResult Footer()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                Icerik footer = unitOfWork.Icerikler.Find(l => l.IcerikKategoriId == 7 && l.DilId == 4);
                ViewBag.iletisim = unitOfWork.Icerikler.FindAll(i => i.IcerikKategoriId == 5 && i.DilId == 4).ToList();
        ...
        public ActionResult OurServices()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> hizmetler = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 2 && s.DilId == 4).ToList();
        ...
        public ActionResult AboutUs()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> hakkimizda = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 3 && s.DilId == 4).ToList();
        ...
        public ActionResult WhyUs()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> nedenBiz = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 4 && s.DilId == 4).ToList();
        ...
        [HttpPost]
        [Route("ru/ContactUs")]
        public ActionResult ContactUs(BizeUlasinDTO bizeUlasinModel)
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                string body = "<div style='display: flex; flex-direction: column; align-items: stretch; justify-content: stretch; font-family:arial,helvetica,sans-serif;'>" +
                                    ...
                                    "<table style='padding: 20px;'>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Имя Фамилия : </strong></td>" +
                                            $"<td style='border-bottom: 1px solid #19335c; padding-left: 10px;'>{bizeUlasinModel.AdSoyad}</td>" +
                                        "</tr>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Номер телефона : </strong></td>" +
                                            $"<td style='border-bottom: 1px solid #19335c; padding-left: 10px;'>{bizeUlasinModel.Telefon}</td>" +
                                        "</tr>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Адрес электронной почты : </strong></td>" +
                                            $"<td style='border-bottom: 1px solid #19335c; padding-left: 10px;'>{bizeUlasinModel.Email}</td>" +
                                        "</tr>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Сообщение : </strong></td>" +
        ...
        public ActionResult Contact()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> iletisim = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 5 && s.DilId == 4).ToList();
        ...
        public ActionResult Faq()
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                List<Icerik> sss = unitOfWork.Icerikler.FindAll(s => s.IcerikKategoriId == 6 && s.DilId == 4).ToList();
        ...
        [HttpPost]
        [Route("ru/Reservation")]
        public ActionResult Reservation(RezervasyonBilgileri rezervasyonBilgileri)
        {
            using (var unitOfWork = new UnitOfWork(new ImperialDatabaseContext()))
            {
                ...
                string body = "<div style='display: flex; flex-direction: column; align-items: stretch; justify-content: stretch; font-family:arial,helvetica,sans-serif;'>" +
                                    "<h3 style='background-color: #19335c; color: #f5b754; padding:30px; text-align: center; font-size: 24px; margin: 0;'>Imperial VIP Transfer</h3>" +
                                    "<h6 style='background-color: #19335c; color: #f5b754; padding-bottom:30px; text-align: center; font-size: 15px; font-weight: 300; margin: 0;'>Подробности бронирования</h3>" +
                                    "<table style='padding: 20px;'>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Имя Фамилия : </strong></td>" +
                                        ...
                                        "</tr>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Место назначения : </strong></td>" +
                                        ...
                                        "</tr>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Номер рейса : </strong></td>" +
                                            $"<td style='border-bottom: 1px solid #19335c; padding-left: 10px;'>{rezervasyonBilgileri.UcusNumarasi}</td>" +
                                        "</tr>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Дата возврата : </strong></td>" +
                                        ...
                                        "</tr>" +
                                        "<tr style='line-height: 35px; text-align: left;'>" +
                                            "<td style='border-bottom: 1px solid #19335c; width: 150px; padding-left: 10px;'><strong>Количество людей : </strong></td>" +
