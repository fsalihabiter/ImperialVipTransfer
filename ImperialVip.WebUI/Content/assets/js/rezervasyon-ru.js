...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        alisNoktasi.addEventListener("change", function (event) {
            ...
            $.ajax({
                url: "/ru/VarisNoktasiBelirle",
                data: { alisNoktasiId: id },
                type: "POST",
                dataType: "Json",
                success: function (data) {
                    $("#VarisNoktasiId").empty(); $("#VarisNoktasiId").append("<option value='' >Выберите местоположение</option>")
            ...
            while (currentCount < desiredCount) {
                ...
                newPersonField.innerHTML = `
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon3">${currentCount}. Имя Фамилия</span>
        ...
        document.getElementById("rezervasyonYap").addEventListener("click", function (event) {
            ...
            $.ajax({
                ...
                dataType: "Json",
                success: function (data) {
                    alert("Ваша запись бронирования создана.");
                },
