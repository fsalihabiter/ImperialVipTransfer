...
}, optgroup_header: (e, t) => '<div class="optgroup-header">' + t(e[i]) + "</div>", option: (e, i) => "<div>" + i(e[t]) + "</div>", item: (e, i) => "<div>" + i(e[t]) + "</div>", option_create: (e, t) => '<div class="create">Добавить отель <strong>' + t(e.input) + "</strong>&hellip;</div>", no_results: () =>'<div class="no-results">Запись отеля не найдена. Вы можете добавить отель, введя его название...</div>',loading:()=>'<div class="spinner"></div>',not_loading:()=>{},dropdown:()=>"<div></div>"}
