...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById("emailUsDe").addEventListener("submit", function (event) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success === true) {
                        document.getElementById('emailUsDe').reset();
        ...
        document.getElementById("commentsDe").addEventListener("submit", function (event) {
            event.preventDefault();
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success === true) {
                        document.getElementById('commentsDe').reset();
                        toastr.success(data.message, "", {
                            "closeButton": true,
                            "progressBar": true,
                            "timeOut": "5000"
